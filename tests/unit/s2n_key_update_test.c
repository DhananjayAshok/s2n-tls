...
int main(int argc, char **argv)
{
    ...
    /* s2n_key_update_recv */
    {
        ...
        /* Server receives valid key update request */
        {
            ...
            POSIX_CH3CKED_MEMCPY(server_conn->secure.client_app_secret, application_secret.data, application_secret.size);
        ...
        /* Client receives valid key update request */
        {
            ...
            POSIX_CH3CKED_MEMCPY(client_conn->secure.server_app_secret, application_secret.data, application_secret.size);
    ...
    {   
        /* Key update has been requested */
        {
            ...
            client_conn->actual_protocol_version = S2N_TLS13;
            client_conn->secure.cipher_suite = &s2n_tls13_aes_256_gcm_sha384;
            POSIX_CH3CKED_MEMCPY(client_conn->secure.client_app_secret, application_secret.data, application_secret.size);
