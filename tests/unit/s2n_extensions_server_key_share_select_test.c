...
int main() {
...

    {
         ...
         * a Hello Retry Request flag is not set and the server ignores the keyshare. */
        {
            ...
            POSIX_CH3CKED_MEMSET(client_params0->kem_params.public_key.data, 1, kem_group0->kem->public_key_length);
         ...
         * KEM group 1, Hello Retry Request is not sent and server chooses group 1. */
        {
            ...
            /* The PQ public key is fake; that's good enough for this test */
            POSIX_CH3CKED_MEMSET(client_params1->kem_params.public_key.data, 1, kem_group1->kem->public_key_length);
         ...
         * Hello Retry Request is not sent and server chooses group 0. */
        {
            ...
            for (size_t i = 0; i < kem_pref->tls13_kem_group_count; i++) {
                ...
                /* The PQ public key is fake; that's good enough for this test */
                POSIX_CH3CKED_MEMSET(client_params->kem_params.public_key.data, 1, kem_group->kem->public_key_length);
